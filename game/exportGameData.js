...
const SEDAN_TYPES = ['small_sedan','big_sedan','medium_sedan'];
...
function biasVal(v,k){ if(v==='medium_car')    return['a','d','w','x'].includes(k)?-1
                                                :['s','f','e','c'].includes(k)?1:0;
                       if(v==='medium_sedan')  return['g','j','y','n'].includes(k)?-1
                                                :['h','k','u','m'].includes(k)?1:0;
                       return 0; }
